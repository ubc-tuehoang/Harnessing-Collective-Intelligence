...
if __name__ == "__main__":
    ...
    # Convert the FAISS vector store into a retriever for vectorDataOne
    ...
    while True:
        ...
        faiss_vectorstore_one = load_new_data(str(result), faiss_vectorstore_one, vectorDataOne_index)

        # Update the retriever with the new FAISS index
        qa_chain.retriever = faiss_vectorstore_one.as_retriever(search_kwargs={"k": 5})
