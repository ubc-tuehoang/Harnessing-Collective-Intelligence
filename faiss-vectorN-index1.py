...
if __name__ == "__main__":
    ...
    print(f"\nPrompt suggestions:\nTell me about Remy.\nHáblame del Silver Surfer.\nMe fale sobre o Superman.")
    ...
    while True:
        ...
        filename = f"result_files/result_{timestamp}.txt"
        ...
        # Automatically load the result content into both FAISS indexes for the next query
